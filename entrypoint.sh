...
echo "==================================="
echo "Starting Litely Perplexed Services"
echo "==================================="

# Start SearXNG
echo "[1/2] Starting SearXNG..."
...
echo "[2/2] Waiting for SearXNG to be ready..."
sleep 5
...
# Start unified backend (serves both API and frontend)
echo "[3/3] Starting unified backend (API + Frontend)..."
cd /app

# Start uvicorn with static file serving
